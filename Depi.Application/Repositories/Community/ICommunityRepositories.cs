...
public interface ICommunityPostRepository : IRepository<CommunityPost>
{
    ...
    Task<List<CommunityPost>> GetByAuthorIdAsync(Guid authorId);
...
public interface IPostCommentRepository : IRepository<PostComment>
{
    ...
    Task<List<PostComment>> GetByAuthorIdAsync(Guid authorId);
...
{
    Task<List<PostBookmark>> GetByUserIdAsync(Guid userId);
...
public interface IForumThreadRepository : IRepository<ForumThread>
{
    ...
    Task<List<ForumThread>> GetByAuthorIdAsync(Guid authorId);
